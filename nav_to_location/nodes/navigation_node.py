...
class NavigationLibrary(object):
    def __init__(self):
        ...
        self.save_location_ser = rospy.Service("/nav/save_location", SaveToLocation, self.save_location_callback)
    ...
    def save_location_callback(self, data):
        ...
        if ret:
            return SaveToLocationResponse(True)
        return SaveToLocationResponse(False)
